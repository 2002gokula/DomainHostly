      ...
      <div className="title">
        <section id="prodetails" class="section-p1">
          <div class="single-pro-image">
            <img
              src="https://codecanyon.img.customer.envatousercontent.com/files/245626796/preview.jpg?auto=compress%2Cformat&amp;q=80&amp;fit=crop&amp;crop=top&amp;max-h=8000&amp;max-w=590&amp;s=380f9c4c2e4b62401153955a5b1658ea"
              width="100%"
              class="main"
              id="MainImg"
              alt=""
            ...
            <div class="small-img-group">
              <div class="small-img-col">
                <img
                  src="https://www.muvi.com/wp-content/uploads/2022/04/What-are-the-Business-Benefits-of-DVR-enabled-Live-Streams.jpg"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src=" https://meetings.skift.com/wp-content/uploads/2018/04/15-Best-Live-Streaming-Apps-for-Events-Ranked.jpg"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/245626801/03_preview3.png"
                  class="each1"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/245626801/08_preview8.png"
                  class="each1"
                  alt=""
                />
              </div>
          ...
          <div class="single-pro-details">
            <h6>LiveStream - Live Channel and Live Stream Website</h6>
            <h4>Live Channel and Live Stream Website And Android Apps </h4>
        ...
        <div class="ProductImage">
          <img
            src="https://s3.envato.com/files/245626801/07_preview7.png"
            alt=""
          />
          <img
            src="https://s3.envato.com/files/245626801/01_preview1.png"
            alt=""
          />
          <img
            src="https://streamingsites.com/wp-content/uploads/screenshots/9234/small/tvplayer-v973.png"
            alt=""
          />
        </div>
        <div class="feature3">
