      ...
      <div className="title">
        <section id="prodetails" class="section-p1">
          <div class="single-pro-image">
            <img
              src="https://s3.envato.com/files/269969023/Screenshoot/0.png"
              width="100%"
              class="main"
              id="MainImg"
              alt=""
            ...
            <div class="small-img-group">
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/269969023/Screenshoot/1.png"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src=" https://s3.envato.com/files/269969023/Screenshoot/10.png"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/269969023/Screenshoot/12.png"
                  class="each1"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/269969023/Screenshoot/2.png"
                  class="each1"
                  alt=""
                />
              </div>
          ...
          <div class="single-pro-details">
            <h6>Computer Hardware Management System</h6>
            <h4>Computer Hardware Management System </h4>
        ...
        <div class="ProductImage">
          <img
            src="https://s3.envato.com/files/269969023/Screenshoot/3.png"
            alt=""
          />
          <img
            src="https://s3.envato.com/files/269969023/Screenshoot/4.png"
            alt=""
          />
          <img
            src="https://s3.envato.com/files/269969023/Screenshoot/5.png"
            alt=""
          />
        </div>
        <div class="feature3">
