      ...
      <div className="title">
        <section id="prodetails" class="section-p1">
          <div class="single-pro-image">
            <img
              src="https://codecanyon.img.customer.envatousercontent.com/files/353096075/inline.png?auto=compress%2Cformat&amp;q=80&amp;fit=crop&amp;crop=top&amp;max-h=8000&amp;max-w=590&amp;s=7c06c8e8116f5049610e1d0dcddd7a35"
              width="100%"
              class="main"
              id="MainImg"
              alt=""
            ...
            <div class="small-img-group">
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/353096076/6.jpg "
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/353096076/5.jpg"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img src="https://s3.envato.com/files/353096076/1.jpg" alt="" />
              </div>
              <div class="small-img-col">
        ...
        <div class="ProductImage">
          <img src="https://s3.envato.com/files/353096076/3.jpg" alt="" />
          <img src="https://s3.envato.com/files/353096076/4.jpg" alt="" />
          <img src="https://s3.envato.com/files/353096076/2.jpg" alt="" />
          <img
            src="https://www.codezon.net/storage/covers/3646.jpg?v=3.2.0"
            alt=""
          />
          <img
            src="https://res.cloudinary.com/dyloaibww/image/upload/v1632771360/BigImg_scratch.jpg.png"
            alt=""
          />
          <img
