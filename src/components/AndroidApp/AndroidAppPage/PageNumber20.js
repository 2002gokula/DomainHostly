      ...
      <div className="title">
        <section id="prodetails" class="section-p1">
          <div class="single-pro-image">
            <img
              src="https://codecanyon.img.customer.envatousercontent.com/files/379373204/banner-academy-ebook-addon.jpg?auto=compress%2Cformat&amp;fit=crop&amp;crop=top&amp;w=590&amp;h=300&amp;s=e632b001cbc9d315e64de516b065a075"
              width="100%"
              class="main"
              id="MainImg"
              alt=""
            ...
            <div class="small-img-group">
              <div class="small-img-col">
                <img
                  src="https://s3.envato.com/files/379373206/Screenshots/Ebook_details-Academy%20(2).png"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src=" https://s3.envato.com/files/379373206/Screenshots/Ebook-admin-revenue-Academy-Learning-Club.png"
                  class="each"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://kinsta.com/wp-content/uploads/2018/03/best-wordpress-lms-plugins-1-1200x675.jpg"
                  class="each1"
                  alt=""
                />
              </div>
              <div class="small-img-col">
                <img
                  src="https://static05.cminds.com/wp-content/uploads/WordPress_LMS_rectangle_2_Illustrative_Banner_Blog.jpg"
                  class="each1"
                  alt=""
                />
              </div>
          ...
          <div class="single-pro-details">
            <h6>Academy LMS Ebook Selling Addon</h6>
            <h4>
              This addon provides Ebook selling facility to your Academy Lms
              students. Aside from the online courses, you can also teach your
              students by selling books to your students{" "}
            </h4>
        ...
        <div class="ProductImage">
          <img
            src="https://bloggingwizard.com/wp-content/uploads/2021/04/The-Best-WordPress-LMS-Plugins-Compared-Featured.png"
            alt=""
          />
          <img
            src="https://fluentcrm.com/wp-content/uploads/2021/09/best-lms-plugins.png"
            alt=""
          />
          <img
            src="https://fluentcrm.com/wp-content/uploads/2021/09/WooCommerce-Email-Marketing-Tips.png"
            alt=""
          />
          <img
            src="https://i0.wp.com/www.learnworlds.com/app/uploads/2020/09/learnworlds.png?resize=1381%2C773&amp;ssl=1"
            alt=""
          />
          <img
            src="https://i0.wp.com/www.learnworlds.com/app/uploads/2020/09/learndash.png?resize=1304%2C660&amp;ssl=1"
            alt=""
          />
        </div>
        <div class="feature3">
